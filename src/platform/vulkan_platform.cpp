...
void vulkan_platform::pickPhysicalDevice()
{
...
void vulkan_platform::createGraphicsPipeline()
{
	...
	auto vertShaderCode = readFile("res/shaders/basic_vert.spv");
	auto fragShaderCode = readFile("res/shaders/basic_frag.spv");
...
void vulkan_platform::createBuffer(VkDeviceSize size, VkBufferUsageFlags usage, VkMemoryPropertyFlags properties, VkBuffer& buffer, VkDeviceMemory& bufferMemory)
{
...
void vulkan_platform::copyBuffer(VkBuffer srcBuff, VkBuffer targetBuff, VkDeviceSize size)
{
...
void vulkan_platform::transitionImageLayout(VkImage image, VkFormat format, VkImageLayout oldLayout, VkImageLayout newLayout)
{
	VkCommandBuffer commandBuffer = beginSingleTimeCommands();
...
void vulkan_platform::copyBufferToImage(VkBuffer buffer, VkImage image, uint32_t width, uint32_t height)
{
	VkCommandBuffer commandBuffer = beginSingleTimeCommands();
...
void vulkan_platform::createDepthResources()
{
...
bool vulkan_platform::hasStencilComponent(VkFormat format)
{
...
void vulkan_platform::createVertexBuffer()
{
...
// create index buffer
void vulkan_platform::createIndexBuffer()
{
...
void vulkan_platform::createDescriptorPool()
{
...
void vulkan_platform::createDescriptorSet()
{
...
void vulkan_platform::drawFrame()
{
...
void vulkan_platform::createTextureImage()
{
...
void vulkan_platform::createTextureImageView()
{
	textureImageView = createImageView(textureImage, VK_FORMAT_R8G8B8A8_UNORM, VK_IMAGE_ASPECT_COLOR_BIT);
}

void vulkan_platform::createTextureSampler()
{
	...
	samplerInfo.maxAnisotropy = 16;  // need to enable this
...
VkImageView vulkan_platform::createImageView(VkImage image, VkFormat format, VkImageAspectFlags aspectFlags)
{
...
void vulkan_platform::createImage(uint32_t width, uint32_t height, VkFormat format, VkImageTiling tiling, VkImageUsageFlags usage, VkMemoryPropertyFlags properties, VkImage& image, VkDeviceMemory& imageMemory)
{
...
VkCommandBuffer vulkan_platform::beginSingleTimeCommands() {
	VkCommandBufferAllocateInfo allocInfo = {};
	allocInfo.sType = VK_STRUCTURE_TYPE_COMMAND_BUFFER_ALLOCATE_INFO;
	allocInfo.level = VK_COMMAND_BUFFER_LEVEL_PRIMARY;
	allocInfo.commandPool = gfxCommandPool;
...
void vulkan_platform::endSingleTimeCommands(VkCommandBuffer commandBuffer) {
...
bool vulkan_platform::isDeviceSuitable(VkPhysicalDevice device)
{
...
// query info
uint32_t vulkan_platform::findMemoryType(uint32_t typeFilter, VkMemoryPropertyFlags properties)
{
